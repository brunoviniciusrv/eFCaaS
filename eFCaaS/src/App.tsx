    ...
    return (
      <div className="h-screen w-full flex flex-col items-center justify-center bg-slate-50 p-6 text-center">
        ...
        <p className="text-slate-600 max-w-md mb-8">
          Sua conta foi suspensa por um administrador. Favor entrar em contato com o suporte para mais informações.
        </p>
        <button 
  ...
  if (user.mustChangePassword) {
    return (
      <div className="h-screen w-full flex flex-col items-center justify-center bg-white p-6 text-center">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-2">Defina sua Senha</h1>
        <p className="text-slate-600 max-w-md mb-8">
          Como este é seu primeiro acesso, você deve definir uma senha pessoal para continuar.
        </p>
        <div className="w-full max-w-sm space-y-4">
          ...
          />
          <button 
            onClick={() => setUser(prev => ({ ...prev, mustChangePassword: false }))}
